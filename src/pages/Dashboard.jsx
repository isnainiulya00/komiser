...
import { FaStar, FaHeart, FaEdit, FaShoppingCart, FaUser, FaEnvelope } from 'react-icons/fa';
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <button onClick={() => navigate('/')} className="p-4 border-2 border-gray-200 rounded-xl hover:border-blue-500 hover:bg-blue-50 transition text-center w-full">
              ...
              <button onClick={() => navigate('/favorites')} className="p-4 border-2 border-gray-200 rounded-xl hover:border-red-500 hover:bg-red-50 transition text-center w-full">
              ...
              <button onClick={() => navigate('/categories')} className="p-4 border-2 border-gray-200 rounded-xl hover:border-purple-500 hover:bg-purple-50 transition text-center w-full">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <button onClick={() => navigate('/edit-profile')} className="p-4 border-2 border-gray-200 rounded-xl hover:border-blue-500 hover:bg-blue-50 transition text-center w-full">
              ...
              <button onClick={() => navigate('/')} className="p-4 border-2 border-gray-200 rounded-xl hover:border-purple-500 hover:bg-purple-50 transition text-center w-full">
              ...
              <button onClick={() => navigate('/categories')} className="p-4 border-2 border-gray-200 rounded-xl hover:border-green-500 hover:bg-green-50 transition text-center w-full">
          ...
          {/* Chat List for Artist */}

          <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">

            <h2 className="text-2xl font-bold text-gray-900 mb-4">Pesan Masuk</h2>

            {(() => {

              // Get all chat conversations for this artist
              ...
              const getAllChats = () => {
                ...
                // Check all possible chat keys

                registeredUsers.forEach(buyer => {

                  if (buyer.email !== user.email && buyer.role !== 'Artist') {

                    const emails = [user.email, buyer.email].sort();
                    ...
                    if (chatData) {
                      ...
                      if (messages.length > 0) {
                        ...
                        // Count unread (messages not from artist)

                        const unreadCount = messages.filter(m => m.senderEmail !== user.email).length;
              ...
              if (chatList.length === 0) {
                ...
                return <p className="text-gray-500 text-center py-8">Belum ada pesan masuk</p>;
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <p className="font-semibold text-gray-900">{chat.buyerName}</p>
